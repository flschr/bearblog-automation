...
Both bots include comprehensive security hardening:

- ✅ **URL Whitelist**: Only downloads from trusted domains
- ✅ **File Size Limits**: Prevents excessive downloads (5MB social, 10MB backup)
- ✅ **Path Traversal Protection**: Sanitized filenames
- ✅ **Authentication Validation**: Checks for expired sessions
- ✅ **Protocol Validation**: Only HTTP/HTTPS allowed
- ✅ **Content-Type Checks**: Validates downloaded content
- ✅ **Rate Limiting**: Exponential backoff for retries
- ✅ **Secure Temp Files**: Proper cleanup after use

---

## 📊 Example Post Structure

After backup, posts are stored as:

```
blog_posts/2024-12-20-my-awesome-post/
├── index.md
├── image-1.webp
└── image-2.webp
```
...
published_date: "2024-12-20T10:30:00Z"
...
You can manually trigger both workflows:

1. Go to **Actions** tab
2. Select **Social Bot** or **Backup Bot**
