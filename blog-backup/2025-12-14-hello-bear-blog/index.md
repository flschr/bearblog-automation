...
Despite the UX flaws and some stability issues, I really enjoyed using Micro.blog and even [contributed](https://github.com/flschr/mbplugin-youtube-nocookie) a [few](https://github.com/flschr/mbplugin-osm-embeds) [plugins](https://github.com/flschr/mbplugin-click2load) to [customize](https://github.com/flschr/mbplugin-goatcounter) the [platform](https://github.com/flschr/mbplugin-goatcounter). It is a great community, and I met a few cool people there whom I will take with me to my new, [independent Mastodon](https://mastodon.social/@fischr) profile.
