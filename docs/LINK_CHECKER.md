...
4. **Report**: Writes results to `archive/bots/linkcheck_bot/broken_links.json`
...
| `link_checker.max_workers` | `3` | Concurrent link checks |
| `link_checker.rate_limit_delay` | `0.5` | Delay between requests to avoid rate limits |
| `link_checker.user_agent` | Browser-like UA | User agent for requests |
